# Contributing to StorRAG

Our goal is to provide a central hub of open source best practices and vetted patterns for building AI enabled applications for the StorRAG Appliance. Below please see how to contribute new components.    
...
Self explanitory. Contributions should contain sufficient code and documentation to be run manually so that developers are able to update and customize them to their own needs.   

A new directory you should add the following files: 
...
This is the most critical file in our directory as in a sense it _IS_ the feature. This yaml file dictates which images make up our AI application and where their container files can be found. Below please see the chabot example.   
