...
There is a [sample text file](./sample-data/sample-data.txt) that can be uploaded in the UI and used to test the RAG capability.
...
The magic happens when you have a bootc enabled system running. If you do, and you'd like to update the operating system to the OS you just built, it's as simple as ssh-ing into the bootc system and running:

```
bootc switch quay.io/your/rag-bootc:latest
```

Upon a reboot, you'll see that the service is running on the system.
